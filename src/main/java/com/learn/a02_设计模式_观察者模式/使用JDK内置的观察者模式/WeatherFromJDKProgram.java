package com.learn.a02_设计模式_观察者模式.使用JDK内置的观察者模式;


import com.learn.a02_设计模式_观察者模式.使用JDK内置的观察者模式.display.DisplayElement;
import com.learn.a02_设计模式_观察者模式.使用JDK内置的观察者模式.observer.Billboard1;
import com.learn.a02_设计模式_观察者模式.使用JDK内置的观察者模式.observer.Billboard2;
import com.learn.a02_设计模式_观察者模式.使用JDK内置的观察者模式.observer.Billboard3;
 ...
 * @version   V0.1.0
 */
public class WeatherFromJDKProgram {
